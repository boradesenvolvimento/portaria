...
EMPRESA_CHOICES = (("1", "BORA"), ("3", "BOURBON"), ("4", "TRANSFOOD"))
...
class DisponibilidadeFrota(models.Model):
    ...
    ordem_servico = models.CharField("Ordem de Serviço", max_length=255, null=True)
...
class RomXML(models.Model):
    ...
    tp_volume = models.CharField(max_length=50, null=True, blank=True)
