# Generated by Django 3.2.6 on 2022-01-12 12:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('portaria', '0073_auto_20220112_0956'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='ticketchamado',
            name='filial',
            field=models.CharField(blank=True, choices=[('SPO', 'SPO'), ('REC', 'REC'), ('SSA', 'SSA'), ('FOR', 'FOR'), ('MCZ', 'MCZ'), ('NAT', 'NAT'), ('JPA', 'JPA'), ('AJU', 'AJU'), ('VDC', 'VDC'), ('MG', 'MG'), ('CTG', 'CTG'), ('TCO', 'TCO'), ('UDI', 'UDI'), ('TNA', 'TNA'), ('VIX', 'VIX')], max_length=3),
        ),
        migrations.AlterField(
            model_name='ticketchamado',
            name='responsavel',
