        ...
        try:
            ...
            if dest_cnpj not in cnpjs:
                ...
                if (
                    ...
                    if tp_volume in ["CX", "Caixas", "CXS", "Caixa"]:
                        tp_volume = "CAIXA"
                vlr_nf = (
...
def estoque_nova_solic(request):
    ...
    if request.method == "POST":
        ...
        print(fil, itens_re)
        obj = EstoqueSolicitacoes.objects.create(
            filial=tipoga[fil],
            colab=colab,
            data_solic=timezone.now(),
            autor=request.user,
        )
