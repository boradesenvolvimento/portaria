...
urlpatterns = [
    ...
    path('paletes/transfdetalhe/<str:solic_id>/', views.transfdetalhe, name='transfdetalhe'),
    ...
    path('frota/disponibilidade-frota?<str:filial>', views.disponibilidade_frota, name='disponibilidade_frota'),
    ...
    path('contratopj/<int:idcpj>/editar', views.contratoeditarpj, name='contratoeditarpj'),
    ...
    path('servicospj/<int:id>/copiar/', views.inserirmesmovalores, name='inserirmesmovalores'),
    ...
    path('get-funcionarios-clt/', views.get_funcionarios_clt, name='get_funcionarios_clt'),
    path('fixa-cadastral/', views.fixa_cadastral, name='fixa_cadastral'),
    path('get-documento-funcionario-clt/<int:id>/', views.get_documento_funcionario_clt, name='get_documento_funcionario_clt'),
    path('get-documento-funcionario-pj/<int:id>/', views.get_documento_funcionario_pj, name='get_documento_funcionario_pj'),
    path('cadastrar-epi-funcionario-clt/<int:id>/', views.cadastrar_epi_funcionario_clt, name='cadastrar_epi_funcionario_clt'),
    path('cadastrar-epi-funcionario-pj/<int:id>/', views.cadastrar_epi_funcionario_pj, name='cadastrar_epi_funcionario_pj'),
