...
urlpatterns = (
    [
        ...
        path(
            "cadastro/cadastroentrada/", views.cadastroentrada, name="cadastroentrada"
        ),
        ...
        path("paletes/recpaletes/", views.transfpalete, name="recpaletes"),
        path("paletes/paineltransferencias", views.paineltransf, name="paineltransf"),
        ...
        path(
            "paletes/transfdetalhecliente/<int:id>/",
            views.transfdetalhecliente,
            name="transfdetalhecliente",
        ),
        ...
        path(
            "frota/disponibilidade-frota",
            views.disponibilidade_frota,
            name="disponibilidade_frota",
        ),
        path(
            "frota/disponibilidade-frota?<str:filial>",
            views.disponibilidade_frota,
            name="disponibilidade_frota",
        ),
        ...
        path("bonuspj/", views.bonuspj, name="bonuspj"),
        path("bonuspj/cadastro", views.bonuscadpj, name="bonuscadpj"),
        path("bonuspj/view", views.bonusviewpj, name="bonusviewpj"),
        path("bonuspj/<int:idbpj>/quitar", views.bonusquit, name="bonusquit"),
        path(r"export-bonus-csv/", views.get_bonus_csv, name="get_bonus_csv"),
        path("contratopj/", views.contratopj, name="contratopj"),
        path("contratopj/cadastro", views.contratocadpj, name="contratocadpj"),
        path("contratopj/view", views.contratoviewpj, name="contratoviewpj"),
        path(
            "contratopj/<int:idcpj>/editar",
            views.contratoeditarpj,
            name="contratoeditarpj",
        ),
        path(r"export-contrato-csv/", views.get_contrato_csv, name="get_contrato_csv"),
        path("servicospj/", views.servicospj, name="servicospj"),
        path(
            "servicospj/<int:args>/cadastro/", views.cadservicospj, name="cadservicospj"
        ),
        path(
            "servicospj/<int:id>/copiar/",
            views.inserirmesmovalores,
            name="inserirmesmovalores",
        ),
        ...
        path(
            "cadastro-funcionariopj/", views.cadfuncionariopj, name="cadfuncionariopj"
        ),
        path("atualizar-funcionariopj/", views.atualizarfunc, name="atualizarfunc"),
        path(
            "get-funcionarios-clt/",
            views.get_funcionarios_clt,
            name="get_funcionarios_clt",
        ),
        path("ficha-cadastral/", views.ficha_cadastral, name="ficha_cadastral"),
        path(
            "get-documento-funcionario-clt/<int:id>/",
            views.get_documento_funcionario_clt,
            name="get_documento_funcionario_clt",
        ),
        path(
            "get-documento-funcionario-pj/<int:id>/",
            views.get_documento_funcionario_pj,
            name="get_documento_funcionario_pj",
        ),
        path(
            "cadastrar-epi-funcionario-clt/<int:id>/",
            views.cadastrar_epi_funcionario_clt,
            name="cadastrar_epi_funcionario_clt",
        ),
        path(
            "cadastrar-epi-funcionario-pj/<int:id>/",
            views.cadastrar_epi_funcionario_pj,
            name="cadastrar_epi_funcionario_pj",
        ),
        ...
        # path(r'chamados/painel/(?P<tktid>[^/]+)/delete', views.chamadodelete, name='chamadodelete'),
        ...
        path(
            "replymail_monitoramento/<tktid>",
            views.replymail_monitoramento,
            name="replymail_monitoramento",
        ),
        ...
        path(
            r"export-checklist-csv/", views.get_checklist_csv, name="get_checklist_csv"
        ),
        ...
        path(
            r"vncmtnotifymanu/",
            views.notifymanutencaovencidos,
            name="notifymanutencaovencidos",
        ),
        ...
        path(
            "compras/lancar_pedido/",
            views.compras_lancar_pedido,
            name="compras_lancar_pedido",
        ),
        path(
            "compras/lancar_direto/",
            views.compras_lancar_direto,
            name="compras_lancar_direto",
        ),
        path("compras/painel/", views.painel_compras, name="painel_compras"),
        path(
            "compras/painel-concluido/",
            views.painel_compras_concluido,
            name="painel_compras_concluido",
        ),
        path("compras/painel/<int:id>/edit", views.edit_compras, name="edit_compras"),
        # path('compras/painel/<id>/edit', views.page_disabled, name='edit_compras'),
        ...
        path(
            "estoque/nova_solicitacao/",
            views.estoque_nova_solic,
            name="estoque_nova_solic",
        ),
        path(
            "estoque/itens/listagem",
            views.estoque_listagem_itens,
            name="estoque_listagem_itens",
        ),
        path(
            "estoque/itens/listagem/<id>/edit",
            views.estoque_detalhe,
        ...
        path(
            ...
            views.get_funcionarios_demissao,
            name="get_funcionarios_demissao",
        ),
