...
urlpatterns = [
    ...
    path('decimopj/<int:idfunc>/caddecimo1', views.caddecimo1, name='caddecimo1'),
    path('decimopj/<int:idfunc>/caddecimo2', views.caddecimo2, name='caddecimo2'),
    path('decimopj/decimoview', views.decimoview, name='decimoview'),
